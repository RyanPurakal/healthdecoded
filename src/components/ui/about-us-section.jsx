...
export default function AboutUsSection() {
  ...
  return (
    ...
    >
      <motion.div
        className="about-hero-orb orb-gold"
        style={{ y: y1, rotate: rotate1 }}
      />
      <motion.div
        className="about-hero-orb orb-blue"
      ...
      >
        ...
        >
          ...
          >
            <Zap className="about-hero-kicker-icon" />
            DISCOVER OUR STORY
          </motion.span>
          <h2>About Health Decoded</h2>
          <motion.div
          ...
          <div className="about-hero-image-wrapper">
            <motion.div className="about-hero-image-card" variants={itemVariants}>
              ...
              >
                ...
                >
                  <Link to="/programs" className="about-hero-image-cta">
