...
export default function SocialConnect() {
  return (
    <section className="py-24 px-4 bg-beige relative" aria-label="Connect with us">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <Link
          href="/contact"
          className="group block max-w-xl mx-auto bg-beige-light rounded-[2rem] p-6 md:p-8 shadow-xl border border-beige-dark hover:shadow-2xl hover:border-indigo-100 hover:-translate-y-1.5 transition-all duration-300"
          aria-label="Navigate to the Contact page"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              <div className="w-16 h-16 rounded-2xl bg-indigo-50 text-indigo-600 flex items-center justify-center group-hover:bg-[#4F62F8] group-hover:text-white transition-colors duration-300 shadow-sm">
              ...
              <div className="text-left">
                <p className="text-sm font-bold text-black uppercase tracking-widest mb-1">Reach out to us</p>
                <p className="text-xl md:text-2xl font-bold text-black group-hover:text-[#4F62F8] transition-colors">Contact Us Page</p>
              </div>
            </div>
            <div className="text-black group-hover:text-[#4F62F8] group-hover:translate-x-2 transition-all duration-300">
