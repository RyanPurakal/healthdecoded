...
function Badge({
  ...
  children,
  ...props
}: { className?: string; children?: ReactNode } & ComponentProps<"span">) {
  return (
...
function Button({
  ...
  children,
  ...props
}: { className?: string; children?: ReactNode } & ComponentProps<"button">) {
  return (
...
const teamMembers: TeamMember[] = [
  {
    ...
    bio: "Ruvanthika is a sophomore at Rutgers University–New Brunswick majoring in Cell Biology and Neuroscience. She is excited to be a part of Health Decoded and is passionate about improving health literacy and access to clear, reliable medical information. In her free time, she enjoys reading, snowboarding, and watching movies.",
  ...
  },
  {
    ...
    bio: "Celdave is a sophomore at Rutgers University-New Brunswick majoring in Biological Sciences. She is thrilled to be a part of Health Decoded and wants to help educate others on health literacy. In her free time she loves to play piano and bake (her favorite dessert to make is double chocolate chip brownies).",
  ...
  },
  {
    ...
    bio: "Ryan is a sophomore majoring in Computer Science at Rutgers. He's really excited to help with the global push for health education through tech initiatives. In his free time he loves to watch movies and shows (his favorites are Se7en and Better Call Saul).",
    image: "/team/ryan.jpg",
  ...
  },
  {
    ...
    bio: "Gil is a sophomore at Rutgers University-New Brunswick, majoring in Biochemistry. He is interested in medicine, wanting to create better knowledge about health care through education. In his free time he loves to go rock climbing and likes to spend time outside.",
    image: "/team/gil.jpg",
  ...
  },
  {
    ...
    bio: "Kartik is a sophomore at Rutgers University-New Brunswick majoring in Cell Biology and Neuroscience. He aspires to make a change in the healthcare community by bringing the truth forward and exposing the complexities in the system. In his free time he enjoys riding as an EMT and making a difference in the lives of others.",
            ...
            <div className="team-card-content">
              <div className="team-card-header">
                <motion.h3
                  ...
                  animate={
                    isHovered && !shouldReduceMotion ? { scale: 1.03 } : { scale: 1 }
                  }
