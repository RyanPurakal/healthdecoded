          ...
          >
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start sm:items-center gap-4 sm:gap-6 min-w-0">
                <div className="w-14 h-14 sm:w-16 sm:h-16 shrink-0 rounded-2xl bg-indigo-50 text-indigo-600 flex items-center justify-center group-hover:bg-[#4279E0] group-hover:text-white transition-colors duration-300 shadow-sm">
                ...
                <div className="text-left min-w-0">
                  ...
                  <p className="text-lg sm:text-xl md:text-2xl font-bold text-black group-hover:text-[#4279E0] transition-colors break-words">Contact Us Page</p>
                </div>
              </div>
              <div className="text-black group-hover:text-[#4279E0] group-hover:translate-x-2 transition-all duration-300 self-end sm:self-auto shrink-0">
